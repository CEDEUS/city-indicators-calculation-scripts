...
setwd("E:/Owncloud Cedeus/Indicadores_de_Sustentabilidad_-_Datos/88._Areas_Verdes_Superficie/")
...
carpeta_manzanas <- "Raw_Data/Poblacion_Manzanas"
carpeta_aavv <- "Raw_Data/Procesado"
...
setwd("E:/Owncloud Cedeus/Indicadores_de_Sustentabilidad_-_Resultados/88._Areas_Verdes_Superficie/")
write.csv(m2_hab, "88.Areas_Verdes_Superficie.csv", row.names = F)
